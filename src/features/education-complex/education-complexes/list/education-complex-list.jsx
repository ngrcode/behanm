...
import renderColumns from "./education-complex-columns";

const trans = "educationComplexes.list";

class EducationComplexList extends Component {
    render() {
...
EducationComplexList.propTypes = {
...
export default withTranslation("educationComplex")(EducationComplexList);
