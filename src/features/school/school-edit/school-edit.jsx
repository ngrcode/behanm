...
const trans = "schoolEdit.schoolEdit";
...
class SchoolEdit extends DoranForm {
    state = {
    ...
    handleSave = async (event) => {
        ...
        await schoolService
            .save({ id, title, educationComplex, region, mosque, howze, contact, coordinate })
            .then(({ data }) => {
...
export default withTranslation("school")(withStyles(styles)(SchoolEdit));
