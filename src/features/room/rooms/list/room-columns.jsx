...
const trans = "rooms.list.roomColumns";

export default function RenderColumns(props) {
    const { t: translate, onDelete, onEdit, status } = props;
    ...
    const columns = [
        ...
        { key: "title", label: translate(`${trans}.title`), content: (item) => item.title, width: "60%" },
        {
            key: "status",
                    ...
                    <List style={styles.root}>
                        ...
                        <ListItem divider style={styles.row}>
                            <Grid container>
                                ...
                                <Grid item xs={8}>
                                    {toJalali(item.createdAt, "DD MMMM YY")}
                                </Grid>
                            </Grid>
                        </ListItem>
                        <ListItem divider style={styles.row}>
                        ...
                        <ListItem divider style={styles.row}>
                            <Grid container>
                                ...
                                <Grid item xs={8}>
                                    {toJalali(item.modifiedAt, "DD MMMM YY")}
                                </Grid>
                            </Grid>
                        </ListItem>
                    </List>
