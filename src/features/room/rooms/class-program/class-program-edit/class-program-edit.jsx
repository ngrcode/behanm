...
const trans = "classProgramEdit.classProgramEdit";
const validTrans = `${trans}.validation`;

class ClassProgramEdit extends DoranForm {
    state = {
    ...
    handleSave = async (event) => {
        ...
        const { id, title, day, zang, lesson, person } = this.state.data;
        const item = {
            id,
            title,
            day: day.value,
            ...
            <DoranDialogOperationPanel {...attributes}>
                ...
                <Grid item sm={6}>
                    {this.renderAutocomplete({
                        ...
                        queryName: "lastName",
                        // defaultCallbackObject: { "roles.name": "ROLE_TEACHER", "schools.id": school.id },
...
export default withTranslation("classProgram")(ClassProgramEdit);
