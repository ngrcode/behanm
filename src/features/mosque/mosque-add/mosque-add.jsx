...
const trans = "mosqueAdd.mosqueAdd";
...
class MosqueAdd extends DoranForm {
    state = {
    ...
    handleSave = async (event) => {
        ...
        const { title, imamName, code, region: rn, howze: hz, person: pr, contacts, coordinates } = this.state.data;
        ...
        await mosqueService
            .save({ title, imamName, code, region, howze, person, contact, coordinate })
            .then(({ data }) => {
                const { onCreate } = this.props;
                onCreate(data);

                const success = this.props.t(`${trans}.createdSuccessfully`, { title: title });
...
export default withTranslation("mosque")(withStyles(styles)(MosqueAdd));
