...
const trans = "mosques.header.mosqueListHeader";
...
function MosqueListHeader(props) {
...
MosqueListHeader.propTypes = {
    onDialog: PropTypes.func.isRequired
};

export default withTranslation("mosque")(MosqueListHeader);
