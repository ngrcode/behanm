...
class UserAdd extends DoranForm {
    state = {
    ...
    handleSave = async (event) => {
        ...
        await userService
            ...
            .then(({ data }) => {
                ...
                const success = this.props.t(`${trans}.createdSuccessfully`, {
...
export default withTranslation("user")(withStyles(styles)(UserAdd));
